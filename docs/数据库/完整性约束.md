...
可以简单的理解为外键不能出现悬空引用, 如[图](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/e0fa20affecb5a6d2c2498656ef05f81.png). 理解外键不能出现悬空之后, 就可以很好的理解外键约束在父表上执行删除或更新操作时的几种选项:
