...
=== "`--mixed`实验1"
    ...
    ![](https://img.ricolxwz.io/2024/08/ca8f91f8fc04b7c531daf5f3bfba93ac.png)
    ...
    `Test this file.`和`Something new...`这两行都被放到了工作区中, 暂存区清空.

    ![](https://img.ricolxwz.io/2024/08/4448a7cf70abf4c08fb9d723cd14d43e.png)
...
=== "`--mixed`实验2"
    ...
    ![](https://img.ricolxwz.io/2024/08/10b76838fb3bbf7c99c62eeefe7e753c.png)
...
=== "`--soft`实验1"
    ...
    `Test this file.`这一行在暂存区中, `Something new...`这一行仍在工作区中
...
=== "`--soft`实验2"
    ...
    `Test this file.`和`Something new...`这两行都被放到了暂存区中.
...
=== "`--hard`实验1"
    ...
    `Test this file.`和`Something new...`这两行都没了. 暂存区清空.

    ![](https://img.ricolxwz.io/2024/08/cf5ce09023b22928e2c54d6dbff93594.png)
