...
笛卡尔积, 又可以叫作Cartesian Product. 可以被表示为RxS = {ts|t∈R∧s∈S}. 也就是说, R中的每一个元组都会和S中的每一个元组配对. 如[图](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/2024/08/41fb587e0c524889d69f3d1782c3f266.png).
...
条件连接, 又叫作Θ连接. 是在笛卡尔积的基础上再加上一个选择运算符. R ⋈Θ S = σΘ (R×S). 如[图](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/2024/08/bd426ebd66d36ac36fefbdf04429db34.png).
...
???+ tip "Tip"
    ...
    如[图](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/2024/08/544a3baef5ea8d499660dacdd610aa38.png).
...
???+ example "例子"
    ...
    另外还有例子, 如[图](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/2024/08/5f27225a266af62d76910969c2f42ce4.png).
...
举一个例子, 如[图](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/2024/08/56e947249dad059e89bf9fca117c7c88.png).
...
如[图](https://cdn.jsdelivr.net/gh/sigmax0124/img@master/2024/08/79349016c11055718d8ce3bc39138192.png).