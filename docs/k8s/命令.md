...
nginx-depl-854bc88786-q44w6   0/1     ContainerCreating   0          6s
$ kubectl get pod
NAME                          READY   STATUS    RESTARTS   AGE
nginx-depl-854bc88786-q44w6   1/1     Running   0          40s
$ # 修改replicas为2
$ kubectl apply -f test.yaml # 注意到这里的replicaset的id没变, 因为只是改变了副本的数量
NAME                          READY   STATUS    RESTARTS   AGE
nginx-depl-854bc88786-q44w6   1/1     Running   0          113s
nginx-depl-854bc88786-g29kj   1/1     Running   0          5s
$ kubectl get replicaset
NAME                    DESIRED   CURRENT   READY   AGE
nginx-depl-854bc88786   2         2         2       3m49s
```